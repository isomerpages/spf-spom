            ...
            <div class="container event-container">
                <div class="row justify-content-center event-highlights-main">
                    <div class="col-md-12 align-center text-center">
                        <ul role="tablist" id="pills-tab" class="nav nav-pills event-navs">
                            <li class="nav-item">
                                <a aria-selected="true" aria-controls="pills-home" role="tab" href="#pills-home" data-toggle="pill" id="pills-home-tab" class="nav-link active">2019</a>
                            </li>
                            <li class="nav-item">
                                <a aria-selected="false" aria-controls="pills2018" role="tab" href="#pills2018" data-toggle="pill" id="pills2018-tab" class="nav-link">2018</a>
                            </li>
                            <li class="nav-item">
                                <a aria-selected="false" aria-controls="pills-profile" role="tab" href="#pills-profile" data-toggle="pill" id="pills-profile-tab" class="nav-link">2017</a>
                            </li>

                        </ul>
                        <!-- ------2019------ -->
                        <div id="pills-tabContent" class="tab-content event-tab-content">
                            <div aria-labelledby="pills-home-tab" role="tabpanel" id="pills-home" class="tab-pane fade show active">
                                <div class="row">
                                    <div class="event">
                                        <div class="col-12 col-sm-6">
                                            <div class="event-image">
                                                <img alt="spom happy hour" src="/files/Assets/media/event/2019/event-1.png">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                ...
                                <div class="row">
                                    <div class="event">
                                        <div class="col-12 col-sm-6">
                                            <div class="event-image">
                                                <img alt="spom happy hour" src="/files/Assets/media/event/2019/event-2.png">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div class="event-details">
                                ...
                                <div class="row">
                                    <div class="event">
                                        <div class="col-12 col-sm-6">
                                            <div class="event-image">
                                                <img alt="WHISKY APPRECIATION NIGHT" src="/files/Assets/media/event/2019/whiskeynight.jpg">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div class="event-details">
                                                ...
                                                <div class="show-more-wrp" id="section">
                                                    <div class="article">
                                                        <p>
                                ...
                                <div class="row">
                                    <div class="event no-border">
                                        <div class="col-12 col-sm-6">
                                            <div class="event-image">
                                                <img alt="spom happy hour" src="/files/Assets/media/event/2019/spomlympic_2019.png">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div class="event-details">
                            ...
                            <div aria-labelledby="pills2018-tab" role="tabpanel" id="pills2018" class="tab-pane fade">
                                <div class="row">
                                    <div class="event">
                                        <div class="col-12 col-sm-6">
                                            <div class="event-image">
                                                <img alt="YEAR-END CARNIVAL" src="/files/Assets/media/event/2018/yearendcarnival2.jpg">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div class="event-details">
                                ...
                                <div class="row">
                                    <div class="event">
                                        <div class="col-12 col-sm-6">
                                            <div class="event-image">
                                                <img alt="November Fest" src="/files/Assets/media/event/2018/novfest.jpg">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div class="event-details">
                                ...
                                <div class="row">
                                    <div class="event">
                                        <div class="col-12 col-sm-6">
                                            <div class="event-image">
                                                <img alt="BBQ NIGHT" src="/files/Assets/media/event/2018/bbqnight.jpg">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div class="event-details">
                                ...
                                <div class="row">
                                    <div class="event">
                                        <div class="col-12 col-sm-6">
                                            <div class="event-image">
                                                <img alt="Happy Hour" src="/files/Assets/media/event/2018/happyhour.jpg">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div class="event-details">
                                ...
                                <div class="row">
                                    <div class="event">
                                        <div class="col-12 col-sm-6">
                                            <div class="event-image">
                                                <img alt="Durian Night" src="/files/Assets/media/event/2018/duriannight.jpg">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div class="event-details">
                                ...
                                <div class="row">
                                    <div class="event  no-border">
                                        <div class="col-12 col-sm-6">
                                            <div class="event-image">
                                                <img alt="Annual Dinner 2018" src="/files/Assets/media/event/2018/annualdinner.jpg">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div class="event-details">
                            ...
                            <!-- -----2017 -->
                            <div aria-labelledby="pills-profile-tab" role="tabpanel" id="pills-profile" class="tab-pane fade">
                                <div class="row">
                                    <div class="event">
                                        <div class="col-12 col-sm-6">
                                            <div class="event-image">
                                                <img alt="spom happy hour" src="/files/Assets/media/event/2017-2019/golf_2017.png">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div class="event-details">
                                ...
                                <div class="row">
                                    <div class="event">
                                        <div class="col-12 col-sm-6">
                                            <div class="event-image">
                                                <img alt="spom happy hour" src="/files/Assets/media/event/2017-2019/photography_2017.png">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div class="event-details">
                                ...
                                <div class="row">
                                    <div class="event">
                                        <div class="col-12 col-sm-6">
                                            <div class="event-image">
                                                <img alt="spom happy hour" src="/files/Assets/media/event/2017-2019/spomlympic_2017.png">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div class="event-details">
                                ...
                                <div class="row">
                                    <div class="event no-border">
                                        <div class="col-12 col-sm-6">
                                            <div class="event-image">
                                                <img alt="spom happy hour" src="/files/Assets/media/event/2017-2019/durian_2017.png">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <div class="event-details">
